...
def write_markdown_report(report: dict, output_path: Path) -> None:
    lines = [
        ...
        "- A separate repair experiment log is generated by `backend/evaluation/deterministic_repair_experiment.py`.",
        "",
...
def main() -> None:
    ...
    report = {
        "metadata": {
            ...
            "repair_experiment_log": "backend/evaluation/results/deterministic_repair_experiment.json",
